...
4. Drag the 3D preview to inspect the finish, or use arrow keys and zoom. Glossy, matte, broken-glass holographic, starry holographic and glitter finishes have approximate material previews.
5. Check shipping details, the creator's terms, the printing total and any separate request fee. Submit once.
