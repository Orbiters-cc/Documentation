...
Identity linking and administrator project operations use separate connections.

```mermaid
flowchart TD
  accTitle: Two GitHub connections
  accDescr: Identity linking and administrator project operations use separate connections.
  A[User OAuth connection] --> B[Account identity]
  C[Administrator project connection] --> D[Repository and project synchronization]
...
See [GitHub Connection Setup Reference](/documentation/orbiters.reference.github-connection-setup) for the detailed contract.
